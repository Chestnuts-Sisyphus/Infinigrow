...
| 桶 | 判据 | 证明等级 |
|---|---|---|
| **执行者侧未落地** | 该拍执行者留痕里带「输出未解析」的**字面标记**（适配器自己打了诚实行：整条回复被当成最终留痕、动作没执行） | [已证明]（字面标记，机械可判） |
| **提议过期** | 领做时芽龄 ≥ 30 拍（出生拍取自芽 ID 拍号段）——提议的前提已老 | [归纳待证] 的**机械代理** |
| **真没做** | 芽龄 < 30 拍，且留痕里没有「未解析」标记 | [已证明]（判据同上） |
